...
function createQuestion() {
    ...
    const audioButton = document.getElementById('listen-button');
    audioButton.style.backgroundColor = "#A14276";
    audioButton.style.color = "#3a001EBB";
    audioButton.style.border = "3px solid #3A001E";
    audioButton.style.boxShadow = "-1px 3px 2px 3px #3A001E";
...
function audioPlay() {
    ...
    if (audioPlayer.paused) {
        audioButton.style.backgroundColor = "#3A001E";
        audioButton.style.color = "#FFDBEEBB";
        audioButton.style.border = "1px solid #FFDBEE";
        audioButton.style.boxShadow = "-1px 3px 2px 3px #3A001E";
        audioPlayer.play();
